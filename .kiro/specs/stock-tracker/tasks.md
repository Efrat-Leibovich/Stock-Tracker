...
- [ ] 3. Checkpoint — וודא שכל הבדיקות עוברות, שאל את המשתמש אם יש שאלות.

- [ ] 4. מימוש StockService
  - [ ] 4.1 מימוש StockService עם Alpha Vantage API
  ...
  - [ ] 4.2 בדיקת property: Search whitespace rejection
    - **Property 6: Search whitespace rejection**
    - **Validates: Requirements 1.3**

  - [ ] 4.3 בדיקת property: API error always returns structured Result
    - **Property 7: API error always returns structured Result**
    - **Validates: Requirements 6.2, 2.3**

  - [ ] 4.4 בדיקות unit: דוגמאות ספציפיות
    - ticker לא קיים מחזיר `NOT_FOUND`
    - רשת לא זמינה מחזיר `NETWORK_ERROR`
    - תגובת API ריקה מחזירה רשימה ריקה
    - _Requirements: 1.2, 6.1, 6.4_

- [ ] 5. Checkpoint — וודא שכל הבדיקות עוברות, שאל את המשתמש אם יש שאלות.

- [ ] 6. מימוש רכיבי הסבר ומילון מונחים
  - [ ] 6.1 מימוש MetricWithTooltip
...
- [ ] 8. חיבור הכל יחד ב-App
  - [ ] 8.1 חיבור כל הרכיבים ב-App.tsx
  ...
  - [ ] 8.2 בדיקות integration
    - חיפוש → בחירת מניה → הוספה לרשימת מעקב
    - הסרה מרשימת מעקב
    - פתיחת מילון מונחים
    - _Requirements: 3.1, 3.2, 4.3, 5.1_

- [ ] 9. Checkpoint סופי — וודא שכל הבדיקות עוברות, שאל את המשתמש אם יש שאלות.
